...
public class ReverHandle : MonoBehaviour
{
    ...
    void HandleClick()
    {
        ...
        if (isset)
        {
            var lock1 = GameObject.Find("lock1");
            var bookshelf = GameObject.Find("bookshelf");
            var reverhouse = GameObject.Find("ReverHouse");
            lock1.GetComponent<Transform>().Translate(0, 0, 10);
            bookshelf.GetComponent<Transform>().Translate(-10, 0, 0);
            reverhouse.GetComponent<Transform>().Translate(-10, 0, 0);
        }
        else
        {
